...
checkpoint_dict: dict[str] = {
    "bees": [list(person1keys(4)), Score_list(0)],
    "turnip": [list(person1keys(8)), Score_list(1)],
    "matcha": [list(person1keys(12)), Score_list(2)],
    "robot": [list(person1keys(16)), Score_list(3)],
    "dolphin": [person1keys[20], Score_list(4)],
    "pickle": [person1keys[24], Score_list[5]],
    "toast": [person1keys[29], Score_list[6]]
    } 
...
def checkpoint_assign(checkpoint_dict: dict[str], MainScore: list[float]) -> str:
    """
    ...
    ----------
        ...
        MainScore: list[float]
            List containing the player's score as floats.
    Returns
    -------
        password: str
...
def checkpoint_execute(checkpoint_dict: dict[str]) -> None:
    """
...
def RetryGame():
    ...
    checkpoint_execute(checkpoint_dict)
